...
public class PatientFile extends JFrame {
	...
	public PatientFile(String patientFile, String doctor, String doctorName) {
		...
		JLabel lblFile, lblPain, lblDrowsiness, lblNausea, lblAnxiety, lblDepression, lblMessage, lblEntries, lblSeverity, lblAction;
		JTextField txtPain, txtDrowsiness, txtNausea, txtAnxiety, txtDepression;
		JButton btnConfirm, btnSendMessage, btnClose;
